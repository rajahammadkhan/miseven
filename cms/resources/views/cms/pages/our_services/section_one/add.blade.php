                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-4">
                                ...
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$our_services_section_one->image ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('image'))
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <input type="text" name="heading" value="{{ $our_services_section_one->heading ?? old('heading') ?? null }}"
                            ...
                            <div class="col-md-8 mt10">
                                ...
                                <textarea required cols="200" class="summernote" name="description">{!! $our_services_section_one->description ?? null !!}</textarea>
                            </div>
                        </div>
                    </form>
                </div>
