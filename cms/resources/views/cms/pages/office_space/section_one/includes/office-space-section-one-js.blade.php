<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#officeSpaceSectionOneDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('office_space_section_one.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('office_space_section_one.edit', [':id']) }}";
          ...
          $('.section-one-status').change(function () {
            ...
            axios
              .post('{{route("office_space_section_one.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-one-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("office_space_section_one.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
