<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#officeSpaceSectionTwoDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('office_space_section_two.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('office_space_section_two.edit', [':id']) }}";
          ...
          $('.section-two-status').change(function () {
            ...
            axios
              .post('{{route("office_space_section_two.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-two-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("office_space_section_two.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
