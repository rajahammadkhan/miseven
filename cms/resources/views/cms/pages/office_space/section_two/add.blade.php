        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('other_pages.office_space')}}">Section Two</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('office_space_section_two.update', [$office_space_section_two->id]) : route('office_space_section_two.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-12 mt10">
                                ...
                                <input type="text" name="category_name" value="{{ $office_space_section_two->heading_one ?? old('category_name') ?? null }}"
