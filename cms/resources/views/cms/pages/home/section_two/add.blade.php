    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <form action="{{ $isEdit ? route('brandhomepage.update', [$brand->id]) : route('brandhomepage.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-2">
                                ...
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$brand->image_one ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('icon'))
                            ...
                            <!-- <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="heading" value="{{ $brand->heading_one ?? old('heading') ?? null }}"
                                    ...
                                    <div class="col-md-12 mt10">
                                        ...
                                        <textarea name="description" class="form-control" required>{{ $brand->description_one ?? old('description') ?? null }}</textarea>
