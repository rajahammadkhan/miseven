<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#homeSectionOneDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('carousel.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('carousel.edit', [':id']) }}";
