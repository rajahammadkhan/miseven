    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <form action="{{ $isEdit ? route('home_section_three.update', [$home_section_three->id]) : route('home_section_three.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-2">
                                <label>Icon <small>(Dimension : 90 x 90) </small> <span class="text-danger"> *</span> </label>
                                <input {{!$isEdit ? 'required' : null}} type="file" name="icon"  class="file" accept="image/*" >
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$home_section_three->image_one ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('icon'))
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="heading" value="{{ $home_section_three->heading_one ?? old('heading') ?? null }}"
                                    ...
                                    <div class="col-md-12 mt10">
                                        ...
                                        <textarea name="description" class="form-control" required>{{ $home_section_three->description_one ?? old('description') ?? null }}</textarea>
