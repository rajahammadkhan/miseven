<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#homeSectionThreeDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('home_section_three.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('home_section_three.edit', [':id']) }}";
          ...
          $('.section-three-status').change(function () {
            ...
            axios
              .post('{{route("home_section_three.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-three-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("home_section_three.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
