        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('other_pages.home')}}">Section Seven</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('home_section_seven.update', [$home_section_seven->id]) : route('home_section_seven.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Section Seven / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-2">
                                <label>Image <small> (Dimensions : 100 x 100) </small> <span class="text-danger"> *</span> </label>
                                <input {{!$isEdit ? 'required' : null}} type="file" name="image"  class="file" accept="image/*" >
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$home_section_seven->image_one ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('icon'))
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="name" value="{{ $home_section_seven->heading_one ?? old('name') ?? null }}"
                                    ...
                                    <div class="col-md-12 mt10">
                                        ...
                                        <textarea required cols="200" class="summernote" name="message">{!! $home_section_seven->heading_two ?? null !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
