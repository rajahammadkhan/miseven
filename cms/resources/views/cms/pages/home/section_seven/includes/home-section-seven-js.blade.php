<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#homeSectionSevenDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('home_section_seven.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
                    ...
                    var checked = row.status == 1 ? 'checked' : null;
                      ...
                      <div class="text-center">
                        <label class="switch s-icons s-outline  s-outline-success  mt-3">
                          <input class="section-seven-status" type="checkbox"  ` + checked + ` value="` + row.id + `">
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('home_section_seven.edit', [':id']) }}";
          ...
          $('.section-six-status').change(function () {
            ...
            axios
              .post('{{route("home_section_seven.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-six-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("home_section_seven.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
