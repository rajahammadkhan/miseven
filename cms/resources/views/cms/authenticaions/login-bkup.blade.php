            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        <!-- <h1 class="">Log In to <a href="index.html"><span class="brand-name">CODUSK</span></a></h1>
                        <p class="signup-link">New Here? <a href="{{ route('signup') }}">Create an account</a></p> -->
                        <div class="row">
                            <div class="col-md-12 mb-5 ml-3">
                                <img src="{{url('')}}/uploads/elite-logo.png" width="300px" height="60px">
                            </div>
                        </div>
                        
                        @if(Session::has('error'))
                        <center><p class="error">{{ Session::get('error') }}</p></center>
                        @endif
                        ...
                        <p class="terms-conditions"> Copyright © 2021 | <a href="#">Elite Business Setup</a></p>
