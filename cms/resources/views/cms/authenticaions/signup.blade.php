...
<head>
    ...
    <title>Codusk Technologies</title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form action="{{ route('signup.store') }}" method="POST" class="text-left">
                         @csrf
                            <div class="form">
                        ...
                        <p class="terms-conditions">© 2020 All Rights Reserved. <a href="index.html">Codusk</a> is a product of Designreset. <a href="javascript:void(0);">Cookie Preferences</a>, <a href="javascript:void(0);">Privacy</a>, and <a href="javascript:void(0);">Terms</a>.</p>
